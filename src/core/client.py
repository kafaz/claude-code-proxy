...
class OpenAIClient:
    ...
    def __init__(
        ...
        # Tune outbound transport for better throughput under concurrency.
        limits = httpx.Limits(
        ...
        self.http_client = httpx.AsyncClient(
            http2=enable_http2, limits=limits, timeout=timeout
        )
    ...
    async def create_chat_completion_stream(
        ...
        try:
            ...
            async for chunk in streaming_completion:
                ...
                # Yield raw dict to avoid extra JSON encode/decode between layers.
                yield chunk.model_dump()

        except asyncio.CancelledError:
            # Downstream disconnected; stop streaming quietly to avoid
            # "response already started" runtime errors.
            return
